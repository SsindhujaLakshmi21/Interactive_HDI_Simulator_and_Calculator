...
### 1. Health Index (LEI)
$$
\text{LEI} = \frac{\text{Life Expectancy} - 20}{85 - 20}
$$
...
$$
* **MYSI** (Mean Schooling Index) = Mean Years of Schooling / 15
* **EYSI** (Expected Schooling Index) = Expected Years of Schooling / 18


### 3. Income Index (II)
$$
\text{II} = \frac{\ln(\text{GNI per Capita}) - \ln(100)}{\ln(75000) - \ln(100)}
$$

### 4. Composite Human Development Index (HDI)
$$
\text{HDI} = \sqrt[3]{\text{LEI} \times \text{EI} \times \text{II}}
$$
